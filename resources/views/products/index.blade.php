    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:flex items-center md:space-x-4 float-end">
                    <input type="text" id="search"
                        class="sm:w-48 px-4 py-2 border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 rounded-md shadow-sm"
                        placeholder="Search...">
                ...
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('products.create') }}"
                            class="open-modal px-4 py-1 bg-blue-500 text-white rounded ajax-click-page flex items-center">
